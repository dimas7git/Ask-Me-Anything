...
const (
	MessageKindCreatedMessage = "message_created"
)
...
func (h apiHandler) handleCreateMessage(w http.ResponseWriter, r *http.Request) {
	...
	go h.notifyClients(Message{Kind: MessageKindCreatedMessage, Value: MessageMessageCreated{ID: messageID.String(), Message: body.Message}, RoomID: rawRoomID})
}
